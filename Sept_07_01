...
Software QA Engineer with 2+ years of experience in **manual and automation testing** for cloud and virtualization platforms. Proven expertise in **VMware ESXi/NSX-T** and **OpenStack RHOSP (standard, DPDK, HW-Offload compute nodes)**. Skilled in **test automation, regression, performance, scalability, and stress testing** with a strong focus on **fault tolerance, release quality, and CI/CD integration**, delivering measurable improvements in **system reliability, scalability, and customer satisfaction**.  
...
- Automated VMware upgrade workflows with Python & Robot Framework, reducing downtime by **50%** and saving **4 engineer-hours per release**.  
- Expanded regression suite from 15 to 45 automated cases, improving **API coverage by 175%** and identifying **20+ P1 defects pre-production**, raising release quality to **98%**.  
...
- Automated regression testing using Robot Framework, increasing nightly test pass rate from **65% to 95%**.  
...
R.V.R & J.C College of Engineering, Guntur | Jun 2023 | GPA: 8.4/10  
